  ...
  return (
    <>
      <Layout>
        ...
        <div className="flex items-center px-4 py-28 md:px-24 gap-20">
          <div className="flex flex-1">
            <p className="text-4xl font-light pr-15">
              "<span className="text-[#2F63B0] font-normal" >KOACI</span> adalah platform <br></br> layanan financial
              antara <br></br> pebisnis dan investor <br></br> berbasis syariah"
            </p>
          </div>
          <div className="flex flex-col flex-1 gap-4">
            <h2 className="text-4xl md:text-4xl font-normal">Apa Itu Koaci?</h2>
          ...
          <div className="flex flex-1 flex-col gap-4">
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="flex gap-3">
                ...
                <p className="flex flex-1 font-light">
                Kemitraan – Mendefinisikan hak, kewajiban,  serta tanggung jawab tiap pihak diawal  perjanjian.
                </p>
              </div>
              <div className="flex gap-3">
                <span className="flex w-8 h-8 rounded-xl justify-center items-center text-white font-medium bg-[#1EE0B3]">
                ...
                <p className="flex flex-1 font-light">
                Transparansi – Menyampaikan laporan  penggunaan dana serta informasi keberjalanan  investasi dan pembiayaan.
                </p>
              </div>
              <div className="flex gap-3">
                <span className="flex w-8 h-8 rounded-xl justify-center items-center text-white font-medium bg-[#1EE0B3]">
          ...
          <div className="flex flex-col w-full items-center gap-16">
            ...
            <div className="flex w-full justify-between gap-32">
              ...
              <div className="flex flex-1 flex-col gap-4">
                ...
                <p className="text-justify font-light">
                Lulusan kampus UNISBA program studi 
                Matematika dengan predikat Cum Laude, 
                disertai 
                menjadi asisten dosen praktikum 
                matematika. Aktif mengikuti kegiatan organisasi 
                kampus 
                sebagai ketua angkatan Fakultas MIPA 2017 
                UNISBA, serta tergabung dengan ILM MIPA 
                sebagai Koordinator Wilayah Jawa Barat, dan 
                menjabat sebagai wakil ketua BEM Fakultas 
                MIPA periode 2019/2020. Berpengalaman 
                menjalankan bisnis F&B selama 1 tahun, serta 
              ...
              <div className="flex flex-1 flex-col gap-4">
                ...
                <p className="text-justify font-light">
                Lulusan POLBAN tahun 2021 program studi D4 
                Akuntansi Pemerintahan dengan predikat Cum 
                Laude. Aktif berorganisasi dan pernah menjabat 
                sebagai Ketua Himpunan Mahasiswa Akuntansi 
                POLBAN periode 2018/2019. Berpengalaman 
                sebagai Akuntan di perusahaan manufaktur, jasa, 
                dan pariwisata. Sudah tersertifikasi sebagai 
                Teknisi Akuntan Yunior.
                </p>
              </div>
            </div>
          </div>
