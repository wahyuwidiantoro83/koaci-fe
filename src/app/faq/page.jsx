      ...
      <Layout>
        ...
        <div className="flex w-full justify-center px-4 py-10 md:py-16 md:px-24">
          <Tabs defaultValue="umum" className="flex flex-col w-full items-center">
            <TabsList className="flex w-full md:w-fit flex-wrap place-items-center gap-4 mb-16 h-full bg-[#DBF0FC]">
              <TabsTrigger
                className="py-3 text-[#1459A8] data-[state=active]:text-white data-[state=active]:bg-[#8AB3E3] w-fit"
                value="umum"
              >
                Umum
              </TabsTrigger>
            ...
            <TabsContent value="openInvest" className="w-full">
              <Accordion type="single" collapsible className="w-full">
                <AccordionItem className="px-4" value="item-1">
                  <AccordionTrigger className="text-lg">Apa itu Koaci?</AccordionTrigger>
                  <AccordionContent className="bg-[#DBF0FC] p-4 rounded-xl text-sm font-lght">
            ...
            <TabsContent value="closedProject" className="w-full">
              <Accordion type="single" collapsible className="w-full">
                <AccordionItem className="px-4" value="item-1">
                  <AccordionTrigger className="text-lg">Apa itu Koaci?</AccordionTrigger>
                  <AccordionContent className="bg-[#DBF0FC] p-4 rounded-xl text-sm font-lght">
