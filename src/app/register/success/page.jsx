    ...
    <>
      <div className="h-dvh w-full overflow-auto font-roboto">
        ...
        <div className="flex w-full h-full justify-center items-center">
          <div className="flex flex-col items-center px-4 md:px-24 py-16">
            <h1 className="text-4xl mb-6 text-center">Anda Telah Berhasil Mendaftar</h1>
            ...
            <button className="bg-[#1EE0B3] text-white text-xl hover:bg-green-500 hover:text-white px-4 py-2 rounded-lg w-fit md:w-96">
